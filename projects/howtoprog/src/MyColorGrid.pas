...
type
  ...
  TMyColorGrid = class(TCustomControl)
  private
...
constructor TMyColorGrid.Create(AOwner: TComponent);
begin
...
function TMyColorGrid.ColorToIndex(AColor: TColor): Integer;
var
  I: Integer;
  RealColor: TColor;
begin
...
procedure TMyColorGrid.CreateWnd;
begin
  inherited CreateWnd;
...
procedure TMyColorGrid.DrawSquare(Which: Integer; ShowSelector: Boolean);
var
...
procedure TMyColorGrid.DrawFgBg;
var
...
procedure TMyColorGrid.EnableForeground(Value: Boolean);
begin
...
procedure TMyColorGrid.EnableBackground(Value: Boolean);
begin
...
function TMyColorGrid.GetForegroundColor: TColor;
var
  PalIndex: Integer;
begin
  if FForegroundIndex < 8 then
...
function TMyColorGrid.GetBackgroundColor: TColor;
var
  PalIndex: Integer;
begin
  if FBackgroundIndex < 8 then
...
procedure TMyColorGrid.WMSetFocus(var Message: TWMSetFocus);
begin
  FHasFocus := True;
...
procedure TMyColorGrid.WMKillFocus(var Message: TWMKillFocus);
begin
  FHasFocus := False;
...
procedure TMyColorGrid.KeyDown(var Key: Word; Shift: TShiftState);
var
...
procedure TMyColorGrid.WMGetDlgCode(var Message: TWMGetDlgCode);
begin
  Message.Result := DLGC_WANTARROWS + DLGC_WANTCHARS;
end;

procedure TMyColorGrid.WMSize(var Message: TWMSize);
begin
  DisableAlign;
  try
    inherited;
...
procedure TMyColorGrid.CMCtl3DChanged(var Message: TMessage);
begin
  inherited;
  Invalidate;
end;

procedure TMyColorGrid.MouseDown(Button: TMouseButton; Shift: TShiftState;
  X, Y: Integer);
var
  Square: Integer;
begin
...
procedure TMyColorGrid.MouseMove(Shift: TShiftState; X, Y: Integer);
var
  Square: Integer;
begin
...
procedure TMyColorGrid.MouseUp(Button: TMouseButton; Shift: TShiftState;
  X, Y: Integer);
begin
...
procedure TMyColorGrid.SetBackgroundIndex(Value: Integer);
begin
...
procedure TMyColorGrid.SetForegroundIndex(Value: Integer);
begin
...
procedure TMyColorGrid.SetGridOrdering(Value: TGridOrdering);
begin
...
procedure TMyColorGrid.SetSelection(Value: Integer);
begin
...
function TMyColorGrid.SquareFromPos(X, Y: Integer): Integer;
begin
...
procedure TMyColorGrid.UpdateCellSizes(DoRepaint: Boolean);
var
...
procedure Register;
begin
  RegisterComponents('Samples', [TMyColorGrid]);
end;
